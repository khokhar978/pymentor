    ...
    problems = [
        {
                ...
                "ai_rubric": "\nVALID APPROACHES:\n- Uses input() for name and course (strings).\n- Uses int(input(...)) for age.\n- Uses float(input(...)) for percentage.\n- Uses f-strings or clean formatting to print the card.\n- Output formatting: :.2f is completely optional. Do NOT strictly check or require :.2f (e.g. accept 85.5%, 85.5, or 85.50% as fully solved).\n\nCOMMON BEGINNER MISTAKES:\n- Forgetting to convert age to int or percentage to float (though pure string printing may work, emphasize type conversion).\n- Using commas in input without understanding strings.\n- Typos in variable names.\n- Messy print statements or missing newlines.\n",
                "teacher_instructions": "Do NOT strictly check for :.2f float formatting (e.g. 85.5% vs 85.50%). As long as the percentage value is printed correctly and the general bio card structure is present, mark the solution as [STATUS: SOLVED]. Do not penalize or fail the student solely for single-decimal vs two-decimal precision."
        },
        {
                "topic": "Variables & Data Types",
